...
\end{tabular}
\\[0.5em]
\footnotesize{$^\dagger$ Error correction experiments used z-score normalized data with different absolute RMSE scale; relative improvements vs. HAR computed on same scale remain valid for comparison.}
\end{table}
